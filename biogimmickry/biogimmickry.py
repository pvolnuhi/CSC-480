...
def create_program(fe: FitnessEvaluator, max_len: int) -> str:
    """
    Return a program string that, when interpreted, populates a memory array
    that exactly matches a target array, and is no longer than max_len.
